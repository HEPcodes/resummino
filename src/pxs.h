...
double real_quark_gaugino_gluino_onshell(const double, const double, const double,
             const double, const double, const int, Parameters*);
double real_quarkb_gaugino_gluino_onshell(const double, const double, const double,
             const double, const double, const int, Parameters*);

double real_quark_gaugino_gluino_onshell_13(const double , const double, const double ,
                                            const double , const double ,int , Parameters*);
double real_quarkb_gaugino_gluino_onshell_13(const double , const double, const double ,
                                             const double, const double, int, Parameters*);

double real_quark_gaugino_gluino_onshell_23(const double , const double, const double ,
                                            const double , const double, int, Parameters*);
double real_quarkb_gaugino_gluino_onshell_23(const double , const double, const double ,
                                             const double, const double, int, Parameters*);
...
double DipGAB_GLGA(const double, const double, const double,
                      const double, const double, const int, Parameters*);
double DipGBA_GLGA(const double, const double, const double,
                      const double, const double, const int, Parameters*);
double DipGA1_GLGA(const double, const double, const double,
                      const double, const double, const int, Parameters*);
double DipGB1_GLGA(const double, const double, const double,
                      const double, const double, const int, Parameters*);
double DipG1A_GLGA(const double, const double, const double,
                      const double, const double, const int, Parameters*);
double DipG1B_GLGA(const double, const double, const double,
                      const double, const double, const int, Parameters*);
...
double real_quarkb_leptons(const double, const double, const double,
                      const double, const double, const int, Parameters*);
double DipGA_leptons(const double, const double, const double,
                     const double, const double, const int, Parameters*);
double DipGB_leptons(const double, const double, const double,
                     const double, const double, const int, Parameters*);
double DipQA_leptons(const double, const double, const double,
                     const double, const double, const int, Parameters*);
double DipQB_leptons(const double, const double, const double,
                     const double, const double, const int, Parameters*);
...
double real_quarkb_sleptons(const double, const double, const double,
                       const double, const double, const int, Parameters*);
double DipGA_sleptons(const double, const double, const double,
                      const double, const double, const int, Parameters*);
double DipGB_sleptons(const double, const double, const double,
                      const double, const double, const int, Parameters*);
double DipQA_sleptons(const double, const double, const double,
                      const double, const double, const int, Parameters*);
double DipQB_sleptons(const double, const double, const double,
                      const double, const double, const int, Parameters*);
