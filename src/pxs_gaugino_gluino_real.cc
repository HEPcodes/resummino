...
double real_gluon_gaugino_gluino(const double S, const double M2,
...
// contributions.
double real_quark_gaugino_gluino(const double S, const double M2,
                                 const double PT2, const double TH,
                                 const double PH, const int YS,
                                 Parameters *params) {
  double born = 0.0;
...
// contributions.
double real_quarkb_gaugino_gluino(const double S, const double M2,
                                  const double PT2, const double TH,
                                  const double PH, const int YS,
                                  Parameters *params) {
  double born = 0.0;
...
// on-shell resonance.
double real_quark_gaugino_gluino_onshell_23(const double S, const double S2,
...
// on-shell resonance.
double real_quark_gaugino_gluino_onshell_13(const double S, const double S2,
                                            const double T1, const double S1,
                                            const double PHI, int flag,
                                            Parameters *params) {
  double born = 0.0;
...
// on-shell resonance.
double real_quarkb_gaugino_gluino_onshell_13(const double S, const double S2,
                                             const double T1, const double S1,
                                             const double PHI, int flag,
                                             Parameters *params) {
  double born = 0.0;
...
// on-shell resonance.
double real_quarkb_gaugino_gluino_onshell_23(const double S, const double S2,
                                             const double T1, const double S1,
                                             const double PHI, int flag,
                                             Parameters *params) {
  double born = 0.0;
...
double Dip_GLGA(DipoleType Emitter_Spectator, PartonType emitter,
  ...
  case INITIAL_INITIAL:
    if (emitter == PARTON_QUARK && spectator == PARTON_ANTIQUARK &&
      ...
      // Dipole factor.
      Dipole = D_ai_b(PARTON_QUARK, PARTON_GLUON, ff->pap3, ff->papb, ff->pbp3,
                      x, 1, 0.5 * (cA - 2.0 * cF));
      ...
      ff->SetDipKinematicAB(x);
      Dipole = D_ai_b(PARTON_GLUON, PARTON_QUARK, ff->pap3, ff->papb, ff->pbp3,
                      x, 1, 0.5 * (cA - 2.0 * cF) / cF * TR);

    } else if (emitter == PARTON_GLUON && spectator == PARTON_GLUON &&
               emitted_parton == PARTON_ANTIQUARK) { //  D_gq_g

      ff->SetDipKinematicAB(x);
      Dipole = D_ai_b(PARTON_GLUON, PARTON_ANTIQUARK, ff->pap3, ff->papb,
                      ff->pbp3, x, 1, 0);
      ...
      ff->SetDipKinematicBA(x);
      Dipole = D_ai_b(PARTON_GLUON, PARTON_QUARK, ff->pbp3, ff->papb, ff->pap3,
                      x, 1, 0);
      ...
      ff->SetDipKinematicBA(x);
      Dipole = D_ai_b(PARTON_GLUON, PARTON_GLUON, ff->pbp3, ff->papb, ff->pap3,
                      x, 1, 0);
      ...
      ff->SetDipKinematicAB(x);
      Dipole = D_ai_b(PARTON_GLUON, PARTON_GLUON, ff->pap3, ff->papb, ff->pbp3,
                      x, 1, 0);
    }
  ...
  case INITIAL_FINAL:
    if (emitter == PARTON_QUARK && spectator == PARTON_GLUINO &&
      ...
      Dipole = D_ai_j(PARTON_QUARK, PARTON_GLUON, zi, zj, ff->pap3, ff->p1p3, x,
                      1, -0.5 * cA);
      ...
      ff->SetDipKinematicA1(x, zi, zj);
      Dipole = D_ai_j(PARTON_GLUON, PARTON_ANTIQUARK, zi, zj, ff->pap3,
      ...
      ff->SetDipKinematicB1(x, zi, zj);
      Dipole = D_ai_j(PARTON_GLUON, PARTON_QUARK, zi, zj, ff->pbp3, ff->p1p3, x,
                      1, -0.5 * cA / cF * TR);
    }
  case FINAL_INITIAL:
    if (emitter == PARTON_GLUINO && spectator == PARTON_QUARK &&
      ...
      Dipole =
          D_ij_a(PARTON_GLUON, PARTON_GLUINO, 0.0, params->mGL, params->mGL,
                 ff->p1p3, x, 1, zj, params->mGL, zi, zplus, zminus, -0.5 * cA);
