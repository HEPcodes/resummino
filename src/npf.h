...
// sets PV-integrals
static void SetA(double ml1s, int ieps, complex<double> *a0, complex<double> *a00) {
...
static void SetB(double p1s, double ml1s, double ml2s, int ieps, 
                 complex<double> *b0, complex<double> *b1, 
                 complex<double> *b00, complex<double> *b11, 
                 complex<double> *db0, complex<double> *db1, complex<double> *db00, complex<double> *db11) {
...
static void SetC(double p1s, double p2s, double p3s, double ml1s, double ml2s, double ml3s, int ieps, 
                 complex<double> *c0, complex<double> *c00, complex<double> *c1, complex<double> *c2, complex<double> *c11, complex<double> *c12, complex<double> *c22 ) {
...
static void SetC(double p1s, double p2s, double p3s, double ml1s, double ml2s, double ml3s, int ieps, 
complex<double> *c0, complex<double> *c00, complex<double> *c1, 
complex<double> *c2, complex<double> *c11, complex<double> *c12, complex<double> *c22, 
complex<double> *c001, complex<double> *c002, complex<double> *c111, complex<double> *c112, complex<double> *c122, complex<double> *c222 ) {
...
static void SetD(double p1s, double p2s, double p3s, double p4s, double pas, double pbs, double ml1s, double ml2s, double ml3s, double ml4s, int ieps, complex<double> *d0, complex<double> *d1, complex<double> *d2, complex<double> *d3, complex<double> *d00, complex<double> *d11, complex<double> *d22, complex<double> *d33, complex<double> *d12,complex<double> *d13, complex<double> *d23 ) {
...
static void SetD(double p1s, double p2s, double p3s, double p4s, double pas, double pbs, double ml1s, double ml2s, double ml3s, double ml4s, int ieps, complex<double> *d0, complex<double> *d1, complex<double> *d2, complex<double> *d3, complex<double> *d00, complex<double> *d11, complex<double> *d22, complex<double> *d33, complex<double> *d12,complex<double> *d13, complex<double> *d23, complex<double> *d001,  complex<double> *d002,  complex<double> *d003,  complex<double> *d111,  complex<double> *d112,  complex<double> *d113,  complex<double> *d122,  complex<double> *d123,  complex<double> *d133,  complex<double> *d222,  complex<double> *d223,  complex<double> *d233,  complex<double> *d333 ) {
