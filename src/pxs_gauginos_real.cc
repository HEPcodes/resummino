    ...
    if (qt >= 0) {
        for (int i0 = 2 * qs; i0 < qs + 2; i0++) {
            for (int i1 = 6 * qt; i1 < 6 * qt + 6; i1++) {
                ...
                ff->SetPropagator(params->mv[i0], params->mSQ[i1],
                                  0.0, 0.0);
                ff->SetWCoupling(Cw);
                born += 2.0 * ff->MGst();
            }
    ...
    if (qt >= 0) {
        for (int i0 = 2 * qs; i0 < qs + 2; i0++) {
            for (int i1 = 6 * qt; i1 < 6 * qt + 6; i1++) {
                ...
                ff->SetPropagator(params->mv[i0], params->mSQ[i1], 0.0, params->mSQ[i1] * WIDTH);
                ff->SetWCoupling(Cw);
                born += 2.0 * ff->MQst();
            }
        }
    ...
    if (qt >= 0 && qu <= 1) {
        for (int i0 = 6 * qt; i0 < 6 * qt + 6; i0++) {
            for (int i1 = 6 * qu; i1 < 6 * qu + 6; i1++) {
                ...
                ff->SetPropagator(params->mSQ[i0], params->mSQ[i1], params->mSQ[i0] * WIDTH, params->mSQ[i1] * WIDTH);
