...
double Vqcd(const double S, const double T, Parameters *params) {
  ...
  for (int i0 = 2 * qs; i0 < qs + 2; i0++) {
    for (int i1 = 2 * qs; i1 < qs + 2; i1++) {
      ...
      ff->SetPropagator(params->mv[i0], params->mv[i1], params->Gv[i0],
                        params->Gv[i1]);
      ff->SetWCoupling(Cw);
#ifdef TR1S
    ...
    for (int i0 = 6 * qt; i0 < 6 * qt + 6; i0++) {
      for (int i1 = 6 * qt; i1 < 6 * qt + 6; i1++) {
        ...
        ff->SetPropagator(params->mSQ[i0], params->mSQ[i1],
                          params->mSQ[i0] * 1.0e-2, params->mSQ[i1] * 1.0e-2);
        ff->SetWCoupling(Cw);
#ifdef BO1
        virt += ff->MVtbo1t(0.0, 0.0, ff->m1s, ff->m2s, 2.0 * ff->papb,
                            ff->m1s - 2.0 * ff->pap1, params->mqs[bb], 0.0,
                            params->mqs[aa], params->mSQs[i0], IEPS);
#endif
#ifdef TR1
        virt += ff->MVttr1t(0.0, ff->m1s - 2. * ff->pap1, ff->m1s,
                            params->mqs[aa], 0.0, params->mSQs[i0], IEPS);
#endif
#ifdef TR2
        virt += ff->MVttr2t(0.0, ff->m1s - 2. * ff->pap1, ff->m2s,
                            params->mqs[bb], 0.0, params->mSQs[i0], IEPS);
#endif
#ifdef BU3

        virt +=
            ff->MVtbu3t(ff->m1s - 2.0 * ff->pap1, params->mSQs[i0], 0.0, IEPS);
  ...
  if (qu <= 1) {
    for (int i0 = 6 * qu; i0 < 6 * qu + 6; i0++) {
      for (int i1 = 6 * qu; i1 < 6 * qu + 6; i1++) {
        ...
        ff->SetWCoupling(Cw);
#ifdef BO1
        virt += ff->MVubo1u(0.0, 0.0, ff->m2s, ff->m1s, 2.0 * ff->papb,
                            ff->m2s - 2.0 * ff->pap2, params->mqs[bb], 0.0,
                            params->mqs[aa], params->mSQs[i0], IEPS);
#endif
#ifdef TR1
        virt += ff->MVutr1u(0.0, ff->m2s - 2.0 * ff->pap2, ff->m2s,
                            params->mqs[aa], 0.0, params->mSQs[i0], IEPS);
#endif
#ifdef TR2
        virt += ff->MVutr2u(0.0, ff->m2s - 2. * ff->pap2, ff->m1s,
                            params->mqs[bb], 0.0, params->mSQs[i0], IEPS);
#endif
#ifdef BU3
        virt +=
            ff->MVubu3u(ff->m2s - 2.0 * ff->pap2, params->mSQs[i0], 0.0, IEPS);
#endif
#ifdef BU3C
  ...
  if (qt >= 0) {
    for (int i0 = 2 * qs; i0 < qs + 2; i0++) {
      for (int i1 = 6 * qt; i1 < 6 * qt + 6; i1++) {
        ...
        ff->SetPropagator(params->mSQ[i1], params->mv[i0],
                          params->mSQ[i1] * 1.0e-2, params->Gv[i0]);
        ff->SetWCoupling(Cw2);
#ifdef BO1
        virt += ff->MVtbo1s(0.0, 0.0, ff->m1s, ff->m2s, 2.0 * ff->papb,
                            ff->m1s - 2.0 * ff->pap1, params->mqs[bb], 0.0,
                            params->mqs[aa], params->mSQs[i1], IEPS);
#endif
#ifdef TR1
        virt += ff->MVttr1s(0.0, ff->m1s - 2.0 * ff->pap1, ff->m1s,
                            params->mqs[aa], 0.0, params->mSQs[i1], IEPS);
#endif
#ifdef TR2
        virt += ff->MVttr2s(0.0, ff->m1s - 2. * ff->pap1, ff->m2s,
                            params->mqs[bb], 0.0, params->mSQs[i1], IEPS);
#endif
#ifdef BU3
        virt +=
            ff->MVtbu3s(ff->m1s - 2.0 * ff->pap1, params->mSQs[i1], 0.0, IEPS);
#endif
#ifdef BU3C
  ...
  if (qu <= 1) {
    for (int i0 = 2 * qs; i0 < qs + 2; i0++) {
      for (int i1 = 6 * qu; i1 < 6 * qu + 6; i1++) {
        ...
        ff->SetWCoupling(Cw1);
#ifdef TR1S
        virt += ff->MVstr1u(0.0, 0.0, 2.0 * ff->papb, params->mqs[bb], 0.0,
                            params->mqs[aa], IEPS);
#endif
        ...
        ff->SetWCoupling(Cw2);
#ifdef BO1
        virt += ff->MVubo1s(0.0, 0.0, ff->m2s, ff->m1s, 2.0 * ff->papb,
                            ff->m2s - 2.0 * ff->pap2, params->mqs[bb], 0.0,
                            params->mqs[aa], params->mSQs[i1], IEPS);
#endif
#ifdef TR1
        virt += ff->MVutr1s(0.0, ff->m2s - 2.0 * ff->pap2, ff->m2s,
                            params->mqs[aa], 0.0, params->mSQs[i1], IEPS);
#endif
#ifdef TR2
        virt += ff->MVutr2s(0.0, ff->m2s - 2. * ff->pap2, ff->m1s,
                            params->mqs[bb], 0.0, params->mSQs[i1], IEPS);
#endif
#ifdef BU3
        virt +=
            ff->MVubu3s(ff->m2s - 2.0 * ff->pap2, params->mSQs[i1], 0.0, IEPS);
#endif
#ifdef BU3C
  ...
  if (qt >= 0 && qu <= 1) {
    for (int i0 = 6 * qt; i0 < 6 * qt + 6; i0++) {
      for (int i1 = 6 * qu; i1 < 6 * qu + 6; i1++) {
        ...
        ff->SetWCoupling(Cw1);
#ifdef BO1
        virt += ff->MVtbo1u(0.0, 0.0, ff->m1s, ff->m2s, 2.0 * ff->papb,
                            ff->m1s - 2.0 * ff->pap1, params->mqs[bb], 0.0,
                            params->mqs[aa], params->mSQs[i0], IEPS);
#endif
#ifdef TR1
        virt += ff->MVttr1u(0.0, ff->m1s - 2.0 * ff->pap1, ff->m1s,
                            params->mqs[aa], 0.0, params->mSQs[i0], IEPS);
#endif
#ifdef TR2
        virt += ff->MVttr2u(0.0, ff->m1s - 2. * ff->pap1, ff->m2s,
                            params->mqs[bb], 0.0, params->mSQs[i0], IEPS);
#endif
#ifdef BU3
        virt +=
            ff->MVtbu3u(ff->m1s - 2.0 * ff->pap1, params->mSQs[i1], 0.0, IEPS);
#endif
#ifdef BU3C
        ...
        ff->SetPropagator(params->mSQ[i1], params->mSQ[i0],
                          params->mSQ[i1] * 1.0e-2, params->mSQ[i0] * 1.0e-2);
        ff->SetWCoupling(Cw2);
#ifdef BO1
        virt += ff->MVubo1t(0.0, 0.0, ff->m2s, ff->m1s, 2.0 * ff->papb,
                            ff->m2s - 2.0 * ff->pap2, params->mqs[bb], 0.0,
                            params->mqs[aa], params->mSQs[i1], IEPS);
#endif
#ifdef TR1
        virt += ff->MVutr1t(0.0, ff->m2s - 2.0 * ff->pap2, ff->m2s,
                            params->mqs[aa], 0.0, params->mSQs[i1], IEPS);
#endif
#ifdef TR2
        virt += ff->MVutr2t(0.0, ff->m2s - 2. * ff->pap2, ff->m1s,
                            params->mqs[bb], 0.0, params->mSQs[i1], IEPS);
#endif
#ifdef BU3
        virt +=
            ff->MVubu3t(ff->m2s - 2.0 * ff->pap2, params->mSQs[i1], 0.0, IEPS);
#endif
#ifdef BU3C
...
// gaugino pair production
      ...
      for (int i0 = 2 * qs; i0 < qs + 2; i0++) {
        for (int i1 = 2 * qs; i1 < qs + 2; i1++) {
          struct Coupling Cw[4] = {
              params->vCHCH[i0][ii][jj], params->vqq[i0][bb][j1],
              params->vCHCH[i1][ii][jj], params->vqq[i1][bb][aa]};
          if (is_coupling_null(Cw, 4) == 1) {
            continue;
          }
      ...
      if (qt >= 0) {
        for (int i0 = 6 * qt; i0 < 6 * qt + 6; i0++) {
          for (int i1 = 6 * qt; i1 < 6 * qt + 6; i1++) {
            struct Coupling Cw[4] = {
                params->CHqSQ[jj][bb][i0], params->CHSQq[ii][i0][j1],
                params->CHqSQ[jj][bb][i1], params->CHSQq[ii][i1][aa]};
            if (is_coupling_null(Cw, 4) == 1) {
              continue;
            }
      ...
      if (qu <= 1) {
        for (int i0 = 6 * qu; i0 < 6 * qu + 6; i0++) {
          for (int i1 = 6 * qu; i1 < 6 * qu + 6; i1++) {
            struct Coupling Cw[4] = {
                params->CHqSQ[ii][bb][i0], params->CHSQq[jj][i0][j1],
                params->CHqSQ[ii][bb][i1], params->CHSQq[jj][i1][aa]};
            if (is_coupling_null(Cw, 4) == 1) {
              continue;
            }
        ...
        for (int i0 = 2 * qs; i0 < qs + 2; i0++) {
          for (int i1 = 6 * qt; i1 < 6 * qt + 6; i1++) {
            struct Coupling Cw1[4] = {
                ...
                params->CHqSQ[jj][bb][i1], params->CHSQq[ii][i1][aa]};
            struct Coupling Cw2[4] = {
                params->CHqSQ[jj][bb][i1], params->CHSQq[ii][i1][j1],
                params->vCHCH[i0][ii][jj], params->vqq[i0][bb][aa]};
            if (is_coupling_null(Cw1, 4) == 1) {
              continue;
            }
        ...
        for (int i0 = 2 * qs; i0 < qs + 2; i0++) {
          for (int i1 = 6 * qu; i1 < 6 * qu + 6; i1++) {
            struct Coupling Cw1[4] = {
                ...
                params->CHqSQ[ii][bb][i1], params->CHSQq[jj][i1][aa]};
            struct Coupling Cw2[4] = {
                params->CHqSQ[ii][bb][i1], params->CHSQq[jj][i1][j1],
                params->vCHCH[i0][ii][jj], params->vqq[i0][bb][aa]};
            if (is_coupling_null(Cw1, 4) == 1) {
              continue;
            }
      ...
      for (int j1 = 6 * qt; j1 < 6 * qt + 6; j1++) {
        for (int j2 = 3 * qt; j2 < 3 * qt + 3; j2++) {
          ...
          for (int i1 = 6 * qt; i1 < 6 * qt + 6; i1++) {
            ...
            ff->SetPropagator(params->mSQ[i1], params->mSQ[i1],
                              params->mSQ[i1] * 1.0e-2,
                              params->mSQ[i1] * 1.0e-2);
            ff->SetWCoupling(Cw);
#ifdef BU4
            virt += ff->MVtbu4t(ff->m1s - 2.0 * ff->pap1, params->mqs[j2],
                                params->mGLs, params->mSQs[j0],
                                params->mSQs[j1], IEPS);
...
#ifdef BU4C
              virt +=
                  ff->MVtct4t(params->mSQs[j1], params->mqs[j2], params->mGLs,
          ...
          for (int i0 = 2 * qs; i0 < qs + 2; i0++) {
            struct Coupling Cw[4] = {
                ...
                params->vCHCH[i0][ii][jj], params->vqq[i0][bb][aa]};
            if (is_coupling_null(Cw, 4) == 0) {
              ff->SetPropagator(params->mv[i0], params->mv[i0], params->Gv[i0],
                                params->Gv[i0]);
              ff->SetWCoupling(Cw);
#ifdef BU4
              virt += ff->MVtbu4s(ff->m1s - 2.0 * ff->pap1, params->mqs[j2],
                                  params->mGLs, params->mSQs[j0],
                                  params->mSQs[j1], IEPS);
#endif
              if (j1 == j0) {
#ifdef BU4C
                virt +=
                    ff->MVtct4s(params->mSQs[j1], params->mqs[j2], params->mGLs,
                                params->mSQs[j0], params->mSQs[j1], IEPS);
#endif
              }
            }
          ...
          if (qu <= 1) {
            for (int i1 = 6 * qu; i1 < 6 * qu + 6; i1++) {
              ...
              if (is_coupling_null(Cw, 4) == 0) {
                ...
                ff->SetWCoupling(Cw);
#ifdef BU4
                virt += ff->MVtbu4u(ff->m1s - 2.0 * ff->pap1, params->mqs[j2],
                                    params->mGLs, params->mSQs[j0],
                                    params->mSQs[j1], IEPS);
                ...
                if (j1 == j0) {
#ifdef BU4C
                  virt += ff->MVtct4u(params->mSQs[j1], params->mqs[j2],
                                      params->mGLs, params->mSQs[j0],
                                      params->mSQs[j1], IEPS);
#endif
                }
    ...
    for (int j0 = 6 * qu; j0 < 6 * qu + 6; j0++) {
      for (int j1 = 6 * qu; j1 < 6 * qu + 6; j1++) {
        for (int j2 = 3 * qu; j2 < 3 * qu + 3; j2++) {
          double mls[5] = {params->mq[j2], params->mGL, params->mSQ[j0],
                           params->mSQ[j1]};
          struct Coupling Cs[2] = {params->GLSQq[j0][j2],
                                   params->GLqSQ[j2][j1]};
          if (is_coupling_null(Cs, 2) == 1) {
          ...
          for (int i1 = 6 * qu; i1 < 6 * qu + 6; i1++) {
            ...
            if (is_coupling_null(Cw, 4) == 0) {
              ...
              ff->SetWCoupling(Cw);
#ifdef BU4
              virt += ff->MVubu4u(ff->m2s - 2.0 * ff->pap2, params->mqs[j2],
                                  params->mGLs, params->mSQs[j0],
                                  params->mSQs[j1], IEPS);
...
#ifdef BU4C
                virt +=
                    ff->MVuct4u(params->mSQs[j1], params->mqs[j2], params->mGLs,
                                params->mSQs[j0], params->mSQs[j1], IEPS);
#endif
              }
            }
          ...
          for (int i0 = 2 * qs; i0 < qs + 2; i0++) {
            ...
            if (is_coupling_null(Cw, 4) == 0) {
              ...
              ff->SetWCoupling(Cw);
#ifdef BU4
              virt += ff->MVubu4s(ff->m2s - 2.0 * ff->pap2, params->mqs[j2],
                                  params->mGLs, params->mSQs[j0],
                                  params->mSQs[j1], IEPS);
#endif
...
#ifdef BU4C
                virt +=
                    ff->MVuct4s(params->mSQs[j1], params->mqs[j2], params->mGLs,
                                params->mSQs[j0], params->mSQs[j1], IEPS);
#endif
              }
            }
          ...
          if (qt >= 0) {
            for (int i0 = 6 * qt; i0 < 6 * qt + 6; i0++) {
              struct Coupling Cw[4] = {
                  ...
                  params->CHqSQ[jj][bb][i0], params->CHSQq[ii][i0][aa]};
              if (is_coupling_null(Cw, 4) == 0) {
                ff->SetPropagator(params->mSQ[i0], params->mSQ[i0],
                                  params->mSQ[i0] * 1.0e-2,
                                  params->mSQ[i0] * 1.0e-2);
                ff->SetWCoupling(Cw);
#ifdef BU4
                virt += ff->MVubu4t(ff->m2s - 2.0 * ff->pap2, params->mqs[j2],
                                    params->mGLs, params->mSQs[j0],
                                    params->mSQs[j1], IEPS);
#endif
                if (j1 == j0) {
#ifdef BU4C
                  virt += ff->MVuct4t(params->mSQs[j1], params->mqs[j2],
                                      params->mGLs, params->mSQs[j0],
                                      params->mSQs[j1], IEPS);
#endif
                }
      ...
      for (int j1 = 6 * qt; j1 < 6 * qt + 6; j1++) {
        ...
        for (int j2 = 6 * qt; j2 < 6 * qt + 6; j2++) {
          ...
          for (int i1 = 6 * qt; i1 < 6 * qt + 6; i1++) {
            ...
            ff->SetWCoupling(Cw);
            virt += ff->MVtbu5t(params->mSQs[j2], params->mSQs[j0],
                                params->mSQs[j1], IEPS);
          }
          ...
          for (int i0 = 2 * qs; i0 < qs + 2; i0++) {
            ...
            if (is_coupling_null(Cw, 4) == 0) {
              ff->SetPropagator(params->mv[i0], params->mv[i0], params->Gv[i0],
                                params->Gv[i0]);
              ff->SetWCoupling(Cw);
              virt += ff->MVtbu5s(params->mSQs[j2], params->mSQs[j0],
                                  params->mSQs[j1], IEPS);
            }
          }
#endif
            ...
            for (int i1 = 6 * qu; i1 < 6 * qu + 6; i1++) {
              ...
              if (is_coupling_null(Cw, 4) == 0) {
                ff->SetPropagator(params->mSQ[i1], params->mSQ[i1],
                                  ...
                                  params->mSQ[i1] * 1.0e-2);
                ff->SetWCoupling(Cw);
                virt += ff->MVtbu5u(params->mSQs[j2], params->mSQs[j0],
                                    params->mSQs[j1], IEPS);
              }
            }
          }
          ...
          for (int i1 = 6 * qu; i1 < 6 * qu + 6; i1++) {
            ...
            if (is_coupling_null(Cw, 4) == 0) {
              ff->SetPropagator(params->mSQ[i1], params->mSQ[i1],
                                ...
                                params->mSQ[i1] * 1.0e-2);
              ff->SetWCoupling(Cw);
              virt += ff->MVubu5u(params->mSQs[j2], params->mSQs[j0],
                                  params->mSQs[j1], IEPS);
            }
          }
          ...
          for (int i0 = 2 * qs; i0 < qs + 2; i0++) {
            ...
            if (is_coupling_null(Cw, 4) == 0) {
              ff->SetPropagator(params->mv[i0], params->mv[i0], params->Gv[i0],
                                params->Gv[i0]);
              ff->SetWCoupling(Cw);
              virt += ff->MVubu5s(params->mSQs[j2], params->mSQs[j0],
                                  params->mSQs[j1], IEPS);
            }
          }
#endif
            ...
            for (int i0 = 6 * qt; i0 < 6 * qt + 6; i0++) {
              ...
              if (is_coupling_null(Cw, 4) == 0) {
                ff->SetPropagator(params->mSQ[i0], params->mSQ[i0],
                                  ...
                                  params->mSQ[i0] * 1.0e-2);
                ff->SetWCoupling(Cw);
                virt += ff->MVubu5t(params->mSQs[j2], params->mSQs[j0],
                                    params->mSQs[j1], IEPS);
              }
            }
          }
      ...
      for (int i0 = 2 * qs; i0 < qs + 2; i0++) {
        for (int i1 = 2 * qs; i1 < qs + 2; i1++) {
          ...
          if (is_coupling_null(Cw, 4) == 0) {
            ...
            ff->SetWCoupling(Cw);
#ifdef TR2S
            virt += ff->MVstr2s(0.0, 0.0, 2.0 * ff->papb, params->mGLs,
                                params->mSQs[j0], params->mSQs[j1], IEPS);
#endif
          }
        }
...
#ifdef TR2S
              ff->SetWCoupling(Cw);
              virt += ff->MVstr2t(0.0, 0.0, 2.0 * ff->papb, params->mGLs,
                                  params->mSQs[j0], params->mSQs[j1], IEPS);
#endif
            }
          }
        ...
        for (int i0 = 2 * qs; i0 < qs + 2; i0++) {
          for (int i1 = 6 * qu; i1 < 6 * qu + 6; i1++) {
            ...
            if (is_coupling_null(Cw, 4) == 0) {
              ...
              ff->SetWCoupling(Cw);
#ifdef TR2S
              virt += ff->MVstr2u(0.0, 0.0, 2.0 * ff->papb, params->mGLs,
                                  params->mSQs[j0], params->mSQs[j1], IEPS);
#endif
            }
          }
        ...
        for (int i0 = 4 * qs; i0 < 2 * qs + 4; i0++) {
          for (int i1 = 6 * qt; i1 < 6 * qt + 6; i1++) {
            struct Coupling Cw[4] = {
                ...
                params->CHqSQ[jj][bb][i1], params->CHSQq[ii][i1][aa]};
            if (is_coupling_null(Cw, 4) == 0) {
              ff->SetPropagator(params->mh[i0], params->mSQ[i1],
                                params->mh[i0] * 1.0e-2,
                                params->mSQ[i1] * 1.0e-2);
              ff->SetWCoupling(Cw);
#ifdef TR3
              virt += ff->MVstr3t(0.0, 0.0, 2.0 * ff->papb, params->mGLs,
                                  params->mSQs[j0], params->mSQs[j1], IEPS);
#endif
            }
          }
        ...
        for (int i0 = 4 * qs; i0 < 2 * qs + 4; i0++) {
          for (int i1 = 6 * qu; i1 < 6 * qu + 6; i1++) {
            ...
            if (is_coupling_null(Cw, 4) == 0) {
              ...
              ff->SetWCoupling(Cw);
#ifdef TR3
              virt += ff->MVstr3u(0.0, 0.0, 2.0 * ff->papb, params->mGLs,
                                  params->mSQs[j0], params->mSQs[j1], IEPS);
#endif
            }
          }
    ...
    for (int j0 = (aa / 3) * 6; j0 < (aa / 3 + 1) * 6; j0++) {
      for (int j1 = qt * 3; j1 < qt * 3 + 3; j1++) {
        for (int j2 = qt * 6; j2 < qt * 6 + 6; j2++) {
          struct Coupling Cs[2] = {params->GLSQq[j2][j1],
                                   params->GLSQq[j0][aa]};
          if (is_coupling_null(Cs, 2) == 1) {
            continue;
          }
          ...
          for (int i1 = 6 * qt; i1 < 6 * qt + 6; i1++) {
            struct Coupling Cw[4] = {
                ...
                params->CHqSQ[jj][bb][i1], params->CHSQq[ii][i1][aa]};
            if (is_coupling_null(Cw, 4) == 0) {
              ff->SetPropagator(params->mSQ[j2], params->mSQ[i1],
                                params->mSQ[j2] * 1.0e-2,
                                params->mSQ[i1] * 1.0e-2);
              ff->SetWCoupling(Cw);
#ifdef TR2A
              virt += ff->MVttr3t(0.0, ff->m1s - 2.0 * ff->pap1, ff->m1s,
                                  params->mGLs, params->mSQs[j0], 0.0, IEPS);
#endif
            }
          }
#endif
          ...
          for (int i0 = 2 * qs; i0 < qs + 2; i0++) {
            struct Coupling Cw[4] = {
                ...
                params->vCHCH[i0][ii][jj], params->vqq[i0][bb][aa]};
            if (is_coupling_null(Cw, 4) == 0) {
              ff->SetPropagator(params->mSQ[j2], params->mv[i0],
                                params->mSQ[j2] * 1.0e-2, params->Gv[i0]);
              ff->SetWCoupling(Cw);
#ifdef TR2A
              virt += ff->MVttr3s(0.0, ff->m1s - 2.0 * ff->pap1, ff->m1s,
                                  params->mGLs, params->mSQs[j0],
                                  params->mqs[j1], IEPS);
#endif
            }
          ...
          if (qu <= 1) {
            for (int i1 = 6 * qu; i1 < 6 * qu + 6; i1++) {
              ...
              if (is_coupling_null(Cw, 4) == 0) {
                ...
                ff->SetWCoupling(Cw);
#ifdef TR2A
                virt += ff->MVttr3u(0.0, ff->m1s - 2.0 * ff->pap1, ff->m1s,
                                    params->mGLs, params->mSQs[j0],
                                    params->mqs[j1], IEPS);
#endif
              }
...
double Vttr4(const double S, const double T, Parameters *params) {
  ...
  if (qt >= 0) {
    for (int j0 = (bb / 3) * 6; j0 < (bb / 3 + 1) * 6; j0++) {
      for (int j1 = qt * 3; j1 < qt * 3 + 3; j1++) {
        for (int j2 = qt * 6; j2 < qt * 6 + 6; j2++) {
          struct Coupling Cs[2] = {params->GLqSQ[j1][j2],
                                   params->GLqSQ[bb][j0]};
          if (is_coupling_null(Cs, 2) == 1) {
            continue;
          }
          ...
          if (params->out1 >= 20) {
            ...
            for (int i1 = 6 * qt; i1 < 6 * qt + 6; i1++) {
              ...
              if (is_coupling_null(Cw, 4) == 0) {
                ...
                ff->SetWCoupling(Cw);
#ifdef TR2B
                virt += ff->MVttr4t(0.0, ff->m1s - 2.0 * ff->pap1, ff->m2s,
                                    params->mGLs, params->mSQs[j0],
                                    params->mqs[j1], IEPS);
            ...
            for (int i0 = 2 * qs; i0 < qs + 2; i0++) {
              ...
              if (is_coupling_null(Cw, 4) == 0) {
                ...
                ff->SetWCoupling(Cw);
#ifdef TR2B
                virt += ff->MVttr4s(0.0, ff->m1s - 2.0 * ff->pap1, ff->m2s,
                                    params->mGLs, params->mSQs[j0],
                                    params->mqs[j1], IEPS);
#endif
              }
            ...
            if (qu <= 1) {
              for (int i1 = 6 * qu; i1 < 6 * qu + 6; i1++) {
                ...
                if (is_coupling_null(Cw, 4) == 0) {
                  ...
                  ff->SetWCoupling(Cw);
#ifdef TR2B
                  virt += ff->MVttr4u(0.0, ff->m1s - 2.0 * ff->pap1, ff->m2s,
                                      params->mGLs, params->mSQs[j0],
                                      params->mqs[j1], IEPS);
#endif
                }
        ...
        for (int j2 = qu * 6; j2 < qu * 6 + 6; j2++) {
          ...
          for (int i1 = 6 * qu; i1 < 6 * qu + 6; i1++) {
            ...
            if (is_coupling_null(Cw, 4) == 0) {
              ...
              ff->SetWCoupling(Cw);
#ifdef TR2A
              virt += ff->MVutr3u(0.0, ff->m2s - 2.0 * ff->pap2, ff->m2s,
                                  params->mGLs, params->mSQs[j0],
                                  params->mqs[j1], IEPS);
#endif
            }
          ...
          for (int i0 = 2 * qs; i0 < qs + 2; i0++) {
            ...
            if (is_coupling_null(Cw, 4) == 0) {
              ...
              ff->SetWCoupling(Cw);
#ifdef TR2A
              virt += ff->MVutr3s(0.0, ff->m2s - 2.0 * ff->pap2, ff->m2s,
                                  params->mGLs, params->mSQs[j0],
                                  params->mqs[j1], IEPS);
#endif
            }
          ...
          if (qt >= 0) {
            for (int i1 = 6 * qt; i1 < 6 * qt + 6; i1++) {
              ...
              if (is_coupling_null(Cw, 4) == 0) {
                ...
                ff->SetWCoupling(Cw);
#ifdef TR2A
                virt += ff->MVutr3t(0.0, ff->m2s - 2.0 * ff->pap2, ff->m2s,
                                    params->mGLs, params->mSQs[j0],
                                    params->mqs[j1], IEPS);
#endif
              }
        ...
        for (int j2 = qu * 6; j2 < qu * 6 + 6; j2++) {
          ...
          for (int i1 = 6 * qu; i1 < 6 * qu + 6; i1++) {
            ...
            if (is_coupling_null(Cw, 4) == 0) {
              ...
              ff->SetWCoupling(Cw);
#ifdef TR2B
              virt += ff->MVutr4u(0.0, ff->m2s - 2.0 * ff->pap2, ff->m1s,
                                  params->mGLs, params->mSQs[j0],
                                  params->mqs[j1], IEPS);
#endif
            }
          ...
          for (int i0 = 2 * qs; i0 < qs + 2; i0++) {
            ...
            if (is_coupling_null(Cw, 4) == 0) {
              ...
              ff->SetWCoupling(Cw);
#ifdef TR2B
              virt += ff->MVutr4s(0.0, ff->m2s - 2.0 * ff->pap2, ff->m1s,
                                  params->mGLs, params->mSQs[j0],
                                  params->mqs[j1], IEPS);
#endif
            }
          ...
          if (qt >= 0) {
            for (int i1 = 6 * qt; i1 < 6 * qt + 6; i1++) {
              ...
              if (is_coupling_null(Cw, 4) == 0) {
                ...
                ff->SetWCoupling(Cw);
#ifdef TR2B
                virt += ff->MVutr4t(0.0, ff->m2s - 2.0 * ff->pap2, ff->m1s,
                                    params->mGLs, params->mSQs[j0],
                                    params->mqs[j1], IEPS);
#endif
              }
    ...
    for (int j0 = (bb / 3) * 6; j0 < (bb / 3 + 1) * 6; j0++) {
      for (int j1 = (aa / 3) * 6; j1 < (aa / 3 + 1) * 6; j1++) {
        for (int j2 = qt * 3; j2 < 3 * qt + 3; j2++) {
          struct Coupling Cs[2] = {params->GLqSQ[bb][j0],
                                   params->GLSQq[j1][aa]};
          if (is_coupling_null(Cs, 2) == 1) {
            continue;
          }
          ...
          for (int i1 = 6 * qu; i1 < 6 * qu + 6; i1++) {
            ...
            if (is_coupling_null(Cw, 4) == 0) {
              ...
              virt += ff->MVubo2u(0.0, 0.0, ff->m2s, ff->m1s, 2.0 * ff->papb,
                                  ff->m2s - 2.0 * ff->pap2, params->mSQs[j0],
                                  params->mGLs, params->mSQs[j1],
                                  params->mqs[j2], IEPS);
#endif
            }
...
double Virt_gauginos(const double S, const double T, Parameters *params) {
  ...
  result +=
      0.5 * Vbu1(S, T, params) + 0.5 * Vbu2(S, T, params) + Vbu4(S, T, params);
  result += Vstr2(S, T, params) +
            (Vstr3(S, T, params) + Vttr3(S, T, params) + Vttr4(S, T, params) +
  ...
  // with S)
  result += (Ctt3(S, T, params) + Ctt4(S, T, params) + Ctu3(S, T, params) +
             Ctu4(S, T, params));
#endif
  return result / g3s;
}
