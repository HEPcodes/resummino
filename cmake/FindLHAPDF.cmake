...
find_library(LHAPDF_LIBRARIES LHAPDF HINTS ${LHAPDF}/lib64 ${LHAPDF}/lib ${LHAPDF_LIBDIR})

find_path(LHAPDF_INCLUDE_DIRS LHAPDF/LHAPDF.h HINTS ${LHAPDF}/include ${LHAPDF_INCLUDE_DIR})
